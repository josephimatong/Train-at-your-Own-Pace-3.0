...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  [Language.EN]: {
    ...
    welcomeUser: "Welcome, Joseph",
    managerWelcome: "Team Analytics, Manager Siti",
  ...
  [Language.ZH]: {
    ...
    welcomeUser: "欢迎，约瑟夫 (Joseph)",
    managerWelcome: "团队数据分析，经理 茜蒂 (Siti)",
  ...
  [Language.MS]: {
    ...
    welcomeUser: "Selamat Datang, Joseph",
    managerWelcome: "Analitis Pasukan, Pengurus Siti",
  ...
  [Language.TA]: {
    ...
    welcomeUser: "வரவேற்கிறோம், ஜோசப் (Joseph)",
    managerWelcome: "குழு பகுப்பாய்வு, மேலாளர் சிதி (Siti)",
